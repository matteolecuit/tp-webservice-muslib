...
public class InitController {
    ...
    private void createAlbums() {
        ...
        this.albumService.create(user.getEmail(), new Album(new GregorianCalendar(2020, Calendar.JUNE, 18), "La Machine", imageUrl)).setArtiste(artiste);
        this.titreService.create(user.getEmail(), new Titre(235, "Folie", imageUrl)).setAlbum(this.albumService.findAll().get(0));
        this.titreService.create(user.getEmail(), new Titre(212, "Italia", imageUrl)).setAlbum(this.albumService.findAll().get(0));
        this.titreService.create(user.getEmail(), new Titre(224, "Ça sent bon", imageUrl)).setAlbum(this.albumService.findAll().get(0));
        this.titreService.create(user.getEmail(), new Titre(192, "Pour la street", imageUrl)).setAlbum(this.albumService.findAll().get(0));
        imageUrl = "https://tinyurl.com/y6ejm2st";
        this.albumService.create(user.getEmail(), new Album(new GregorianCalendar(2019, Calendar.JUNE, 14), "Rien 100 Rien", imageUrl)).setArtiste(artiste);
        this.titreService.create(user.getEmail(), new Titre(160, "La Bandite", imageUrl)).setAlbum(this.albumService.findAll().get(1));
        ...
        this.titreService.create(user.getEmail(), new Titre(151, "Real Nega", imageUrl)).setAlbum(this.albumService.findAll().get(3));
        ...
        this.titreService.create(user.getEmail(), new Titre(424, "Money for Nothing", imageUrl)).setAlbum(this.albumService.findAll().get(4));
        this.titreService.create(user.getEmail(), new Titre(252, "Walk of Life", imageUrl)).setAlbum(this.albumService.findAll().get(4));
        this.titreService.create(user.getEmail(), new Titre(246, "Your Latest Trick", imageUrl)).setAlbum(this.albumService.findAll().get(4));
        this.titreService.create(user.getEmail(), new Titre(322, "Why Worry", imageUrl)).setAlbum(this.albumService.findAll().get(4));
